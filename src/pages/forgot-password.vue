          ...
          <ion-grid h-100>
            <ion-row color="primary" justify-content-center h-100>
              <ion-col size-xs="12">
                ...
                <div class="choice ion-padding">
                  Enter the email address associated with your account
                </div>
                <div class="ion-padding error-msg" v-if="store.error">
                  {{ store.error }}
                </div>
                <div class="ion-padding error-msg" v-if="store.message">
                  {{ store.message }}
                </div>
                <div padding>
...
//import { presentLoading } from "../service/common";
