    ...
    <ion-col offset="2" size="4" class="userAdminActive userAdminBorder">
     ...
     <ion-col size="4" class="userAdminBorder">
       <span class="admin">Admin</span>
        ...
        >
          <ion-tab-bar slot="top" class="userAdmin overwriteTab">
            <ion-tab-button
              class="userAdminBorder"
              tab="loginUserPage"
              href="/login/loginUserPage"
            >
...
<script>
import { IonContent, IonTabBar, IonTabs, IonTabButton, IonPage } from "@ionic/vue";
