            ...
            >
              ...
              >
                ...
                <g
                  ...
                  transform="translate(7.793)"
                >
                  <path
                    id="Tracciato_55"
                    data-name="Tracciato 55"
                    d="M144.2,552.4a3.736,3.736,0,0,1,3.475-3.954c1.973,0,3.482,1.654,3.482,3.954a3.742,3.742,0,0,1-3.482,3.952C145.7,556.356,144.2,554.7,144.2,552.4Zm5.539.574c0-2.229-.74-3.905-2.261-3.905-.966,0-1.86,1-1.86,2.663,0,2.323.812,4.011,2.209,4.011C148.969,555.746,149.74,554.515,149.74,552.978Z"
                    transform="translate(-144.063 -548.312)"
                    fill="#fff"
                  />
                  <path
                    id="Tracciato_56"
                    data-name="Tracciato 56"
                    d="M147.689,556.508a3.788,3.788,0,0,1-3.613-4.091,3.879,3.879,0,0,1,3.613-4.093,3.792,3.792,0,0,1,3.621,4.093A3.882,3.882,0,0,1,147.689,556.508Zm0-7.906a3.6,3.6,0,0,0-3.336,3.816c0,2.21,1.4,3.814,3.336,3.814a3.606,3.606,0,0,0,3.344-3.814C151.033,550.206,149.627,548.6,147.689,548.6Zm.153,7.3c-1.426,0-2.347-1.629-2.347-4.149,0-1.82,1.03-2.8,2-2.8,1.5,0,2.4,1.512,2.4,4.044C149.892,554.676,149.03,555.9,147.842,555.9Zm-.349-6.673c-.834,0-1.721.885-1.721,2.524,0,2.352.813,3.872,2.07,3.872,1.028,0,1.773-1.105,1.773-2.63C149.615,550.632,148.822,549.224,147.493,549.224Z"
                    transform="translate(-144.076 -548.325)"
                    fill="#fff"
                  />
                </g>
                <g
                ...
                <g
                  ...
                  transform="translate(48.531)"
                >
                  <path
                    id="Tracciato_67"
                    data-name="Tracciato 67"
                    d="M180.98,552.4a3.737,3.737,0,0,1,3.475-3.954c1.973,0,3.483,1.654,3.483,3.954a3.743,3.743,0,0,1-3.483,3.952C182.482,556.356,180.98,554.7,180.98,552.4Zm5.539.574c0-2.229-.74-3.905-2.261-3.905-.966,0-1.859,1-1.859,2.663,0,2.323.811,4.011,2.209,4.011C185.748,555.746,186.519,554.515,186.519,552.978Z"
                    transform="translate(-180.842 -548.312)"
                    fill="#fff"
                  />
                  <path
                    id="Tracciato_68"
                    data-name="Tracciato 68"
                    d="M184.468,556.508a3.789,3.789,0,0,1-3.613-4.091,3.879,3.879,0,0,1,3.613-4.093,3.793,3.793,0,0,1,3.622,4.093A3.882,3.882,0,0,1,184.468,556.508Zm0-7.906a3.6,3.6,0,0,0-3.336,3.816c0,2.21,1.4,3.814,3.336,3.814a3.607,3.607,0,0,0,3.345-3.814C187.813,550.206,186.406,548.6,184.468,548.6Zm.154,7.3c-1.425,0-2.347-1.629-2.347-4.149,0-1.82,1.029-2.8,2-2.8,1.5,0,2.4,1.512,2.4,4.044C186.671,554.676,185.809,555.9,184.622,555.9Zm-.35-6.673c-.834,0-1.72.885-1.72,2.524,0,2.352.812,3.872,2.07,3.872,1.027,0,1.772-1.105,1.772-2.63C186.394,550.632,185.6,549.224,184.272,549.224Z"
                    transform="translate(-180.855 -548.325)"
                    fill="#fff"
                  />
                </g>
              </g>
            ...
            <ion-row color="primary" justify-content-center>
                ...
                <div padding>
                  <div class="custom-padding-vertical">
                    <div class="dflex-border">
                      <ion-icon
                        ...
                        class="commonStyleIcon"
                      ></ion-icon>
                      <ion-input
                        class="ion-padding-horizontal"
                        type="text"
                        placeholder="Company"
                        v-model="company" name="company" id="company"
                        required
                      ></ion-input>
                    </div>
                  </div>
                  ...
                  <div class="custom-padding-vertical">
                    <div class="dflex-border">
                      ...
                      <ion-input
                        class="ion-padding-horizontal"
                        v-model="password" name="password" id="password"
                        type="password"
                  ...
                  <ion-row class="choice">
                    <ion-col size="12" class="remember">
                      ...
                      ><span
                        >I agree to the<span class="lightred-text"
              ...
              <ion-col size-xs="12" class="ion-text-center">
                <div class="ion-padding-bottom">
                  <ion-button class="common-btn" size="large" @click="doCreateAccount"  expand="block"
                    >Sign up and send request</ion-button
                  >
                </div>
...
import { IonInput, IonButton, IonContent, IonPage } from "@ionic/vue";
import { defineComponent, ref } from "vue";
import { useRouter } from "vue-router";

import { personCircleOutline, mailOpenOutline, lockClosedOutline } from "ionicons/icons";
export default defineComponent({
  components: { IonInput, IonButton, IonContent, IonPage },
  layout: "Signup",
  setup() {
    ...
    const doCreateAccount = async () => {
      ...
      debugger;
      await store.createAccount(email.value, password.value, company.value);
